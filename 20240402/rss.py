...
#read shape file
taiwan=gpd.read_file(r"C:\Users\Ethan\Desktop\cycu_ai2024\cycu_ai2024_ctyang\20240402\county\COUNTY_MOI_1090820.shp")
import os
#print cwd
print (taiwan.shape)
print (taiwan)
...
plt.show()
#save to png file
plt.savefig(r"C:\Users\Ethan\Desktop\cycu_ai2024\20240402")